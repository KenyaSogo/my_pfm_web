...
class SimulationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create simulation" do
    assert_difference('Simulation.count') do
      post simulations_url, params: { simulation: { asset_id: @simulation.asset_id, last_generated_at: @simulation.last_generated_at, name: @simulation.name } }
    end
  ...
  test "should update simulation" do
    patch simulation_url(@simulation), params: { simulation: { asset_id: @simulation.asset_id, last_generated_at: @simulation.last_generated_at, name: @simulation.name } }
